...
- Keep in mind all of the role IDs, channel IDs, etc. were all for my test server that I used. You must configure it yourself by changing the IDs to meet your needs.
